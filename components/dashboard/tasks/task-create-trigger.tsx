...
// ✅ FIXED: Rename to CreateTaskDialog and export as default
...
// ✅ FIXED: Export a trigger component that manages its own state
export default function TaskCreateTrigger() {
    ...
    return (
        <>
            <Button
                ...
                className="rounded-full bg-white text-black hover:bg-neutral-200 shadow-2xl px-6 py-2.5 h-auto text-sm font-medium gap-2 group transition-all duration-300 hover:scale-105 active:scale-95"
            >
